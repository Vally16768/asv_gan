...
class DetectorWrapper:
    ...
    def __init__(self, keras_loader_fn=None):
        # ignorăm keras_loader_fn (nu mai e nevoie); KerasASV se auto-încarcă din ./ASVmodel
        self.feats = LogMel()
        self.keras = KerasASV(loader_fn=None)
    ...
    def keras_prob(self, wave: torch.Tensor) -> np.ndarray:
        ...
        # standardize dacă e scalar (compat cu config-ul tău)
